...
export default function Game() {
    ...
    const game = {
        home: { name: "Trocean", color: "#9900FF", manager: "Trocean", record: "1-6", scores: [0, 0, 0, 0, 0, 0, 0], R: 0, H: 0, E: 0, LOB: 0 },
        away: { name: "THANdrew", color: "#999999", manager: "THANdrew", record: "4-3", scores: [0, 0, 0, 0, 0, 0, 0], R: 0, H: 0, E: 0, LOB: 0 },
    };
