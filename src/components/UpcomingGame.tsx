...
export default function Game() {
    ...
    const game = {
        away: { name: "Morgan", color: "#FF00FF", manager: "Morgan", record: "2-4", scores: [0, 0, 0, 0, 0, 0, 0], R: 0, H: 0, E: 0, LOB: 0 },
        home: { name: "THANdrew", color: "#999999", manager: "THANdrew", record: "4-2", scores: [0, 0, 0, 0, 0, 0, 0], R: 0, H: 0, E: 0, LOB: 0 },
    };
