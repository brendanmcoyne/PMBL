...
export default function Game() {
    ...
    const game = {
        home: { name: "Trocean", color: "#9900FF", manager: "Trocean", record: "1-4", scores: [0, 0, 0, 0, 0, 0, 0], R: 0, H: 0, E: 0, LOB: 0 },
        away: { name: "Morgan", color: "#FF00FF", manager: "Morgan", record: "1-4", scores: [0, 0, 0, 0, 0, 0, 0], R: 0, H: 0, E: 0, LOB: 0 },
    };
