...
export default function Game() {
    ...
    const game = {
        away: { name: "Justave", color: "#FF9900", manager: "Justave", record: "3-3", scores: [0, 0, 0, 0, 0, 0, 0], R: 0, H: 0, E: 0, LOB: 0 },
        home: { name: "James", color: "#F1C232", manager: "James", record: "5-1", scores: [0, 0, 0, 0, 0, 0, 0], R: 0, H: 0, E: 0, LOB: 0 },
    };
        ...
        <ContentDiv>
            <TeamsRow>
                ...
                <TeamColumn>
                    ...
                    <Logo src="/emblems/MSS-Emblem-BowserJr.webp" alt={`${game.home.name} logo`} />
