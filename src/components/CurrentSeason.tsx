...
export default function CurrentSeason() {
    ...
    const eastTeams = [
        { name: 'Marge', color: "#6AA84F", record: '3-1', divRecord: '1-0' },
        { name: 'Brendan', color: "#CC0000", record: '0-3', divRecord: '1-1' },
        { name: 'Justave', color: "#FF9900", record: '1-3', divRecord: '1-1' },
        { name: 'James', color: "#F1C232", record: '1-3', divRecord: '0-1' },
    ];

    const westTeams = [
        { name: 'Trocean', color: "#9900FF", record: '3-1', divRecord: '2-0' },
        { name: 'Morgan', color: "#FF00FF", record: '3-1', divRecord: '0-1' },
        { name: 'Isaac', color: "#3586E8", record: '2-2', divRecord: '1-1' },
        { name: 'THANdrew', color: "#999999", record: '2-2', divRecord: '0-1' },
    ];
    ...
    const Week1 = [
        ...
        { matchup: 4, away: "Brendan", awaycolor: "#CC0000", home: "Marge", homecolor: "#6AA84F", score: "5-7" },
    ];
    ...
    const Week2 = [
        ...
        { matchup: 3, away: "Morgan", awaycolor: "#FF00FF", home: "Trocean", homecolor: "#9900FF", score: "3-10" },
        { matchup: 4, away: "Brendan", awaycolor: "#CC0000", home: "THANdrew", homecolor: "#999999", score: "10-11" },
    ];

    const Week3 = [
        { matchup: 1, away: "Isaac", awaycolor: "#3586E8", home: "James", homecolor: "#F1C232", score: "4-7" },
        { matchup: 2, away: "Trocean", awaycolor: "#9900FF", home: "Marge", homecolor: "#6AA84F", score: "7-8" },
        { matchup: 3, away: "Morgan", awaycolor: "#FF00FF", home: "Brendan", homecolor: "#CC0000", score: "4-2" },
        { matchup: 4, away: "THANdrew", awaycolor: "#999999", home: "Justave", homecolor: "#FF9900", score: "7-5" },
    ];

    const Week4 = [
        { matchup: 1, away: "James", awaycolor: "#F1C232", home: "Morgan", homecolor: "#FF00FF", score: "5-7" },
        { matchup: 2, away: "Trocean", awaycolor: "#9900FF", home: "Isaac", homecolor: "#3586E8", score: "12-1" },
        { matchup: 3, away: "Justave", awaycolor: "#FF9900", home: "Brendan", homecolor: "#CC0000", score: "4-5" },
        { matchup: 4, away: "Marge", awaycolor: "#6AA84F", home: "THANdrew", homecolor: "#999999", score: "8-4" },
    ];
    ...
    const ConfSeries = [
        { matchup: 1, away: "Isaac", awaycolor: "#3586E8", home: "Marge", homecolor: "#4AA84F", record: "0-0"},
        { matchup: 2, away: "Morgan", awaycolor: "#FF00FF", home: "Trocean", homecolor: "#9900FF", record: "0-0"},
    ]
