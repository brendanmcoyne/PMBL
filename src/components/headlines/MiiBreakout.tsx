...
export default function MiiBreakout() {
    return (
        <ContentDiv>
            ...
            fielding, and Bowser for his pitching to name a few. The stars of the league are usually dominant in their certain aspect of play.</Passage>
            ...
            <Passage>The Mii Players Union (M.P.U.) believes that Miis deserve a lot more credit and respect on the field and in the press, as they are
            some of the most, if not the most, hardest working players in the league as a whole.</Passage>

            <Passage>The Head Analyst of the league came out with this statement: "I truly belive the Mii stock will boom this upcoming season.
            ...
            but they can and will easily put your team in a position to succeed.</Passage>
            ...
            <Passage>Theres been some great stories for Miis this season in the league. Many Miis were given a chance by their managers to play, and
            many of them capitalized.</Passage>

            <Passage>Nose was selected as the last pick of the draft (12th Round, 96th Overall), and was not used on Manager Brendan's team at all
            during his tenure. Near the end of Week 5, Nose was traded to Manager DANdrew and the Spitballs in return for Michelle Obama. Nose was
            put into the lineup in Week 6 at shortstop, and played impressive ball, helping DANdrew rally off 3 wins to end the season at 5 - 5, just
            barely missing the playoffs.</Passage>

            <Passage>He tied for runner up in both the Most Improved Player and Comeback Player of the Year award, and even got a job at the Mushroom
            Kingdom Herald during his down time. </Passage>

            <Passage>Subsequently in the draft, Manager James took Tate McRae as the penultimate pick (12th Round, 95th Overall), and was put into
            action in Week 7, when Manager James and the Monsters had a 3 - 3 record after a bad 7 - 13 loss to Christach. In a lineup where there
            was so much firepower when it came to batting, Tate McRae added even more, by recording hit after hit almost every single game. She
            ...
            competitive. The Managers Union will be discussing </Passage>
            <SeparatorLine />
