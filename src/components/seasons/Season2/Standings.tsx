...
export default function Standings2() {
    return (
        <ContentDiv>
            ...
            <StyledHeader>Season 2 PMBL Standings</StyledHeader>
            <StandingsContainer>
                <DivisionDiv>
                    ...
                    <GridRow>
                        <div style={{ fontWeight: "bold", color: "#CC0000" }}>Brendan<sup style={{color: "#A0A0A0"}}>e</sup></div>
                        <div>4 - 6</div>
                        <div>2 - 4</div>
                        <div>W1</div>
                        <div>72</div>
                ...
                <DivisionDiv>
                    ...
                    <GridRow>
                        <div style={{ fontWeight: "bold", color: "#3586E8" }}>Isaac<sup style={{color: "#FF9900"}}>y</sup></div>
                        <div>7 - 3</div>
                        <div>4 - 2</div>
                        <div>L1</div>
                        <div>62</div>
                    ...
                    <GridRow>
                        <div style={{ fontWeight: "bold", color: "#FF00FF" }}>Morgan<sup style={{color: "#38761D"}}>x</sup></div>
                        <div>5 - 5</div>
                        <div>3 - 3</div>
                        <div>W1</div>
                        <div>67</div>
                    ...
                    <GridRow>
                        <div style={{ fontWeight: "bold", color: "#999999" }}>THANdrew<sup style={{color: "#A0A0A0"}}>e</sup></div>
                        <div>5 - 5</div>
                        <div>2 - 4</div>
                        <div>L1</div>
                        <div>56</div>
