...
export default function Season3() {
    return(
        <ContentDiv>
            ...
            <StyledMiniHeader style={{marginTop: "40px", textAlign: "center", color: "white"}}>Click down below to see all Season 3 stats</StyledMiniHeader>

            <LinkButton to="/archives/Season3/Stats" style={{width: "15rem", backgroundColor: "darkblue"}} state={{ stateSet: "set2"}}>
